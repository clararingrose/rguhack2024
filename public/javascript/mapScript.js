...
L.marker([57.13150877365045, -2.103482947724631]).addTo(mymap).bindPopup("Gas lamp pedestal").on('click', () => changeText("Made of red Peterhead granite this stood in Aberdeen’s New Market beside the indoor fountain"));
L.marker([57.13136384280768, -2.09871501573324]).addTo(mymap).bindPopup("The old deeside line").on('click', () => changeText("TThis former railway line, 1853-1966, is now a popular walking, cycling and horse riding route from the heart of Aberdeen to the countryside of Aberdeenshire. The railway ran from Aberdeen to Banchory, extending to Ballater in 1856, a total distance of 43¼ miles. It was planned to end at Braemar but Queen Victoria was afraid her privacy would be disturbed by ‘hordes of tourists’ at Balmoral. So she bought land along the route to prevent it. This photograph shows the final train at Culter Station in 1966. Ferryhill Junction, next to the park, was temporarily the city’s first station when the railway came to Aberdeen. The Illustrated London News lithograph below shows the opening in 1850. The Deeside line originally began from here and the engine sheds are still visible at the edge of the park. The Ferryhill Railway Heritage Trust was established in 2007 to restore the remaining building and turntable, and transform the location into a working railway heritage site for the north east of Scotland. See Ferryhill on Facebook for details"));
