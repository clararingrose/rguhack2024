...
L.marker([57.13150877365045, -2.103482947724631]).addTo(mymap).bindPopup("Gas lamp pedestal").on('click', function(){changeText("Made of red Peterhead granite this stood in Aberdeen’s New Market beside the indoor fountain"); addRoutingControl(lat, lon, 57.13150877365045, -2.103482947724631, mymap);confetti()});
